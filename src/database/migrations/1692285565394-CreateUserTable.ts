...
export class CreateUserTable1692285565394 implements MigrationInterface {
    name = 'CreateUserTable1692285565394'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "gallery" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "url" character varying NOT NULL, "purchaseDate" date, "ownerId" integer NOT NULL, CONSTRAINT "PK_65d7a1ef91ddafb3e7071b188a0" PRIMARY KEY ("id"))`);
